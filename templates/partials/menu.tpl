			<div class="navbar-header">
				...
				<div>
					...
					<a href="<!-- IF title:url -->{title:url}<!-- ELSE -->{relative_path}/<!-- ENDIF title:url -->">
						<h1 class="ngo-forum-title navbar-brand forum-title">{title}</h1>
						<h2 class="ngo-forum-subtitle">KTR</h2>
					</a>
			...
			<div class="navbar-collapse collapse navbar-ex1-collapse" id="nav-dropdown">
				...
				<ul id="main-nav" class="nav navbar-nav ngo-navbar-nav pull-left">
					{{{each navigation}}}
				...
				<!-- IF config.loggedIn -->
				<ul id="logged-in-menu" class="nav navbar-nav ngo-navbar-nav navbar-right pull-right">
				...
				<!-- ELSE -->
				<ul id="logged-out-menu" class="nav navbar-nav ngo-navbar-nav navbar-right pull-right">
				...
				<!-- IF config.searchEnabled -->
				<ul class="nav navbar-nav ngo-navbar-nav ngo-navbar-nav--hidden-sm navbar-right">
					<li>
				...
				<ul class="nav navbar-nav ngo-navbar-nav navbar-right pagination-block visible-lg visible-md">
					<li class="dropdown">
